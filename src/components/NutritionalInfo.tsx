  ...
  return (
    ...
    >
      <div className="flex flex-col items-center lg:items-start">
        <span className="text-base sm:text-xl lg:text-3xl font-bold">{meat.calories.toFixed(1)}</span>
        <span className="text-[9px] sm:text-xs lg:text-sm text-gray-500 font-medium">Calorías</span>
      </div>
      <div className="flex flex-col items-center lg:items-start">
        <span className="text-base sm:text-xl lg:text-3xl font-bold">{meat.protein.toFixed(1)}</span>
        <span className="text-[9px] sm:text-xs lg:text-sm text-gray-500 font-medium">Proteína</span>
      </div>
      <div className="flex flex-col items-center lg:items-start">
        <span className="text-base sm:text-xl lg:text-3xl font-bold">{meat.fat.toFixed(1)}</span>
        <span className="text-[9px] sm:text-xs lg:text-sm text-gray-500 font-medium">Grasa</span>
      </div>
      <div className="flex flex-col items-center lg:items-start">
        <span className="text-base sm:text-xl lg:text-3xl font-bold">{meat.carbs.toFixed(1)}</span>
